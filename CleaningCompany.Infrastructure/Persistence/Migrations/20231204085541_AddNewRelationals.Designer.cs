...
namespace CleaningCompany.Infrastructure.Migrations
{
    ...
    [Migration("20231204085541_AddNewRelationals")]
    partial class AddNewRelationals
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleaningCompany.Domain.AggregateModels.OrderAggregate.Entities.OrderEmployee", b =>
                {
                    ...
                    b.Property<Guid>("EmployeeWhoApprovedId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("EmployeeWhoPerformedId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CleaningCompany.Infrastructure.Identity.Entities.CustomIdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("efb71232-22c5-49fc-b0ea-356d1b135e1d"),
                            Name = "Client",
                            NormalizedName = "CLIENT"
                        },
                        new
                        {
                            Id = new Guid("e3bae968-7137-4f2e-bf57-d971eae8735d"),
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("7d188029-f747-4c9b-bdfe-7bdaaff3fb90"),
                            Name = "Worker",
